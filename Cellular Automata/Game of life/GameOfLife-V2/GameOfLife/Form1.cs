...
namespace GameOfLife
{
    ...
    public partial class Form1 : Form
    {
        ...
        private void subMatrix(int x, int y, int rows, int cols) {
            //We gonna use a technique that uses a little bit bigger matrix
            rows += 2;
            cols += 2;
            //Creating a new submatrix
            int[,] sub_matrix = new int[cols, rows];

            //We make a copy of some data in the extra cells 
            ...
            //We know that center cell it's on x, y position
